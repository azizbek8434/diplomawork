...
@section('breadcrumbs', Breadcrumbs::render('complaint.list.all'))

@section('content_header')
<h1>
    Барча муаммолар ройҳати
</h1>
@stop
            ...
            <table id="dataTable" class="table table-bordered table-hover" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr class="item{{$complaint->id}} @if(!$complaint->status) warning @endif ">
                        ...
                        <td class="{{ $complaint->status ? 'text-green' : 'text-red' }}">
                            {{ $complaint->status ? 'Хал бўлди' : 'Хал бўлмади' }}</td>
